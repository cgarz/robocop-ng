...
switch_known_errcodes = {
    ...
    0x20A69: r"Setting group name ends with '.' or contains invalid characters (allowed: [a-z0-9_\-.]) ",
    0x20C69: r"Setting name ends with '.' or contains invalid characters (allowed: [a-z0-9_\-.]) ",
